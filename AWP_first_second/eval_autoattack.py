...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='../model-cifar-resnet18/at/epoch40.pt')
    parser.add_argument('--n_ex', type=int, default=1000)
    parser.add_argument('--individual', action='store_true')
    parser.add_argument('--save_dir', type=str, default='./aa_results')
    parser.add_argument('--batch_size', type=int, default=500)
    parser.add_argument('--log_path', type=str, default='./aa_log_file.txt')
    ...
    for epoch in range(100,200):
        path = 'model-cifar10-wrn3410/0.2_1/epoch'+str(epoch)+'.pt'
        if os.path.exists(path):
            print('epoch ',epoch)
            model = nn.DataParallel(WideResNet(num_classes=10))
